...
// Function to calculate the mass transfer coefficients in the water channels
...
//Function to calculate the concentration polarization at the membrane interface
